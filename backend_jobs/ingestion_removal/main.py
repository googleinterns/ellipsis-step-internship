...
from backend_jobs.ingestion_removal.pipeline_lib.firestore_database import \
...
def _validate_args(args):
    ...
    if args.input_pipeline_run is None and args.input_image_provider is None:
        raise ValueError('missing input e.g. input_image_provider/input_pipeline_runinput_pipeline_run')
